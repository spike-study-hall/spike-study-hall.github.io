...
while(true){
var temp__5733__auto__ = cljs.core.first(adj_list);
if(cljs.core.truth_(temp__5733__auto__)){
var vec__58083 = temp__5733__auto__;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58083,(0),null);
var neighbours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58083,(1),null);
var G__58189 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(out,node,(- cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.vals(neighbours))));
var G__58190 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(cljs.core._PLUS_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([in$,neighbours], 0));
var G__58191 = cljs.core.next(adj_list);
out = G__58189;
in$ = G__58190;
adj_list = G__58191;
continue;
...
return cljs.core.every_QMARK_((function (p__58106){
var vec__58108 = p__58106;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58108,(0),null);
var flow_to_successors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58108,(1),null);
return cljs.core.every_QMARK_(((function (vec__58108,node,flow_to_successors){
return (function (p__58111){
var vec__58112 = p__58111;
var neighbor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58112,(0),null);
var flow_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58112,(1),null);
...
});})(vec__58108,node,flow_to_successors))
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58142_SHARP_){
var or__4131__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(weight_fn,p1__58142_SHARP_);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return (0);
...
return cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58144_SHARP_){
return (loom.flow.residual_capacity(capacity,flow,vertex,p1__58144_SHARP_) > (0));
...
var G__58207 = flow_2;
var G__58208 = capacity;
var G__58209 = cljs.core.next(path);
var G__58210 = increase;
flow = G__58207;
capacity = G__58208;
path = G__58209;
increase = G__58210;
...
while(true){
var temp__5733__auto__ = loom.flow.bf_find_augmenting_path(successors,predecessors,capacity,flow,source,sink);
if(cljs.core.truth_(temp__5733__auto__)){
var path = temp__5733__auto__;
var G__58215 = successors;
var G__58216 = predecessors;
var G__58217 = capacity;
var G__58218 = source;
var G__58219 = sink;
var G__58220 = loom.flow.augment_along_path(flow,capacity,path,loom.flow.min_weight_along_path(path,cljs.core.partial.cljs$core$IFn$_invoke$arity$3(loom.flow.residual_capacity,capacity,flow)));
successors = G__58215;
predecessors = G__58216;
capacity = G__58217;
source = G__58218;
sink = G__58219;
flow = G__58220;
