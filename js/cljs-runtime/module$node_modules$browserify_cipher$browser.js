shadow$provide.module$node_modules$browserify_cipher$browser=function(global,require,module,exports){function createCipheriv(suite,key,iv){suite=suite.toLowerCase();if(aesModes[suite])return aes.createCipheriv(suite,key,iv);if(desModes[suite])return new DES({key:key,iv:iv,mode:suite});throw new TypeError("invalid suite type");}function createDecipheriv(suite,key,iv){suite=suite.toLowerCase();if(aesModes[suite])return aes.createDecipheriv(suite,key,iv);if(desModes[suite])return new DES({key:key,iv:iv,
mode:suite,decrypt:!0});throw new TypeError("invalid suite type");}var DES=require("module$node_modules$browserify_des$index"),aes=require("module$node_modules$browserify_aes$browser"),aesModes=require("module$node_modules$browserify_aes$modes$index"),desModes=require("module$node_modules$browserify_des$modes"),ebtk=require("module$node_modules$evp_bytestokey$index");exports.createCipher=exports.Cipher=function(suite,password){suite=suite.toLowerCase();if(aesModes[suite]){var keyLen=aesModes[suite].key;
