shadow$provide.module$node_modules$asn1_DOT_js$lib$asn1$base$buffer=function(global,require,module,exports){function DecoderBuffer(base,options){Reporter.call(this,options);Buffer.isBuffer(base)?(this.base=base,this.offset=0,this.length=base.length):this.error("Input not Buffer")}function EncoderBuffer(value,reporter){if(Array.isArray(value))this.length=0,this.value=value.map(function(item){item instanceof EncoderBuffer||(item=new EncoderBuffer(item,reporter));this.length+=item.length;return item},
