...
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48580,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48580,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__48591){
var map__48592 = p__48591;
var map__48592__$1 = (((((!((map__48592 == null))))?(((((map__48592.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48592.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48592):map__48592);
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48592__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48592__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48592__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48592__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48592__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__48599 = (new goog.Uri());
G__48599.setScheme(cljs.core.name((function (){var or__4131__auto__ = scheme;
...
G__48599.setDomain(server_name);

G__48599.setPort(server_port);

G__48599.setPath(uri);

G__48599.setQuery(query_string,true);
...
var vec__48653 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__48650_SHARP_,/:\s+/);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48653,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48653,(1),null);
if(((clojure.string.blank_QMARK_(k)) || (clojure.string.blank_QMARK_(v)))){
return p1__48651_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__48651_SHARP_,clojure.string.lower_case(k),v);
}
