...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__40880){
...
var request = map__40881__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40881__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__40886 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__40886.cljs$core$IFn$_invoke$arity$1 ? fexpr__40886.cljs$core$IFn$_invoke$arity$1(response) : fexpr__40886.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__40887 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__40887.cljs$core$IFn$_invoke$arity$1 ? fexpr__40887.cljs$core$IFn$_invoke$arity$1(response) : fexpr__40887.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__40888){
var map__40889 = p__40888;
...
var request = map__40889__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40889__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
