shadow$provide.module$node_modules$parse_asn1$index=function(global,require,module,exports){function parseKeys(buffer){if("object"===typeof buffer&&!Buffer.isBuffer(buffer)){var password=buffer.passphrase;buffer=buffer.key}"string"===typeof buffer&&(buffer=Buffer.from(buffer));var stripped=fixProc(buffer,password);buffer=stripped.tag;stripped=stripped.data;switch(buffer){case "CERTIFICATE":var ndata=asn1.certificate.decode(stripped,"der").tbsCertificate.subjectPublicKeyInfo;case "PUBLIC KEY":ndata||
