...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__48987){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48988__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__48988,map__48988__$1,on_write){
return (function (){
...
});})(node_value,map__48988,map__48988__$1,on_write))
);
} else {
...
return reagent.impl.input.input_handle_change(this$,on_change,p1__48991_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
