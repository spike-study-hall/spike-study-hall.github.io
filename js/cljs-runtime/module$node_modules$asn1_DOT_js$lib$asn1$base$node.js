shadow$provide.module$node_modules$asn1_DOT_js$lib$asn1$base$node=function(global,require,module,exports){function Node(enc,parent){var state={};this._baseState=state;state.enc=enc;state.parent=parent||null;state.children=null;state.tag=null;state.args=null;state.reverseArgs=null;state.choice=null;state.optional=!1;state.any=!1;state.obj=!1;state.use=null;state.useDecoder=null;state.key=null;state["default"]=null;state.explicit=null;state.implicit=null;state.contains=null;state.parent||(state.children=
[],this._wrap())}var Reporter=require("module$node_modules$asn1_DOT_js$lib$asn1$base$index").Reporter,EncoderBuffer=require("module$node_modules$asn1_DOT_js$lib$asn1$base$index").EncoderBuffer,DecoderBuffer=require("module$node_modules$asn1_DOT_js$lib$asn1$base$index").DecoderBuffer,assert=require("module$node_modules$minimalistic_assert$index");global="seq seqof set setof objid bool gentime utctime null_ enum int objDesc bitstr bmpstr charstr genstr graphstr ia5str iso646str numstr octstr printstr t61str unistr utf8str videostr".split(" ");
