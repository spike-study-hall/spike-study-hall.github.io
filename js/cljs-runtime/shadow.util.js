...
var len__4730__auto___46329 = arguments.length;
var i__4731__auto___46330 = (0);
while(true){
if((i__4731__auto___46330 < len__4730__auto___46329)){
args__4736__auto__.push((arguments[i__4731__auto___46330]));

var G__46331 = (i__4731__auto___46330 + (1));
i__4731__auto___46330 = G__46331;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq46236){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46236));
});
...
var len__4730__auto___46336 = arguments.length;
var i__4731__auto___46337 = (0);
while(true){
if((i__4731__auto___46337 < len__4730__auto___46336)){
args_arr__4751__auto__.push((arguments[i__4731__auto___46337]));

var G__46338 = (i__4731__auto___46337 + (1));
i__4731__auto___46337 = G__46338;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.log.cljs$lang$applyTo = (function (seq46248){
var G__46249 = cljs.core.first(seq46248);
var seq46248__$1 = cljs.core.next(seq46248);
var G__46250 = cljs.core.first(seq46248__$1);
var seq46248__$2 = cljs.core.next(seq46248__$1);
var G__46251 = cljs.core.first(seq46248__$2);
var seq46248__$3 = cljs.core.next(seq46248__$2);
var G__46252 = cljs.core.first(seq46248__$3);
var seq46248__$4 = cljs.core.next(seq46248__$3);
var G__46253 = cljs.core.first(seq46248__$4);
var seq46248__$5 = cljs.core.next(seq46248__$4);
var G__46254 = cljs.core.first(seq46248__$5);
var seq46248__$6 = cljs.core.next(seq46248__$5);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46249,G__46250,G__46251,G__46252,G__46253,G__46254,seq46248__$6);
});

shadow.util.log.cljs$lang$maxFixedArity = (6);

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__46303){
var vec__46304 = p__46303;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46304,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46304,(1),null);
